...
?>  
   ...
   <div style="" class="menu" id="style-7">
       <div style="height:200px;"><img id="im5" src="Pics/<?php echo $row['image'];?>">
             <h3 align="center"><?php echo $row["name"]?><br>User Id :<?php echo $row["admin_id"];?><br>(Admin)</h3></div>
       <div  id="nav1">
               <ul>
        ...
        <?php
            ...
            ?>
        <div id="team" style="margin-top:50px"><div id="subheader"><img src="Pics/hand.png" style="width:40px;height:30px;"><span style="color:white; font-size:30px;">Team</span></div><h3 style=" margin:10px;color:black; font-size:23px;">Core Team : 6 (M=4,F=2)<br></h3></div>
