   ...
   <div style="" class="menu" id="style-7">
       ...
       <div  id="nav1">
               <ul>
                   ...
                   <li><a href="student_enroll_portal.php" id="upload_course"  class="active">Register Course</a></li>
...
$sql = "SELECT * FROM course NATURAL JOIN instructor WHERE course_id NOT IN(SELECT course_id FROM enroll WHERE student_id=$student_id) ORDER BY course_id DESC";
$result = $conn->query($sql);
                ...
                <?php 
                    ...
                    if ($result) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            float:left;"><h4 style="color:black;font-size:25px;"><span style="color:#660000;"></span>'.$row["course_name"].'</h4><h5 style="color:purple; font-size:20px;"><span style="color:#650000;">Instructor Name:</span>'.$row["name"].'</h5>Enrolled Student:'.$no_of_student.'<br>#Videos:'.$no_of_video.'<h4>'.$row["description"].'</h4><form action="student_enroll_course.php" method="post">
                              <table >
                                <tr><input type="hidden" name="course_id" value="'.$course_id.'">
                                    <input type="hidden" name="student_id" value="'.$student_id.'">
                                </tr>
                                  <br><br>
                                <tr><td><input type="submit" value="Enroll Now"></td></tr>
                                    </table>
                                    </form><hr></div>';
