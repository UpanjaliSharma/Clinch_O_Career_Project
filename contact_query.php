...
?>        
   <div style="" class="menu" id="style-7">
       ...
       <div  id="nav1">
        ...
        <div id="notice" style="width:98%; height:auto;"><div id="subheader"><img src="Pics/icon.png" style="width:40px;height:30px;"><span style="color:white; font-size:30px;">Students details</span>
            </div>
            
            <?php

$sql = "SELECT * FROM  quick_contact ORDER BY query_id DESC";
$result = $conn->query($sql);
