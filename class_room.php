   ...
   <div style="" class="menu" id="style-7">
       ...
       <div  id="nav1">
               <ul>
                   ...
                   <li><a href="student_enroll_portal.php"id="upload_course">Register Course</a></li>
...
$sql = "SELECT * FROM course  NATURAL JOIN instructor WHERE course_id in (SELECT course_id FROM enroll WHERE student_id=$student_id) ORDER BY course_id DESC";
                ...
                <?php 
                    ...
                    if ($result) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            float:left;"><h4 style="color:black;font-size:25px;"><span style="color:#660000;"></span>'.$row["course_name"].'</h4><h5 style="color:purple; font-size:20px;"><span style="color:#650000;">Instructor Name:</span>'.$row["name"].'</h5>Enrolled Students:'.$no_of_student.'<br>#videos:'.$no_of_video.'<h4>'.$row["description"].'</h4><div id="course"><form action="student_go_to_course.php" method="post">
                              <table >
                                ...
                                <tr><td><input type="submit" value="Go To Course"></td></tr>
                                    ...
                                    <div id="course"><form action="delete_student_course.php" method="post">
                              <table >
                                <tr><input type="hidden" name="course_id" value="'.$course_id.'">
                                </tr>
                                  <br><br>
    ...
    <div class="modal-body">
      <div id="div1">
        <form action="course_upload.php" method="post">
            <table align="right">
                 <tr><input type="hidden" name="student_id" value="<?php echo $student_id;?>">
                    </tr>
                <tr>
