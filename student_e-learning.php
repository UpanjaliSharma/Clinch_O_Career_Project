...
?>        
   <div style="" class="menu" id="style-7">
       ...
       <div  id="nav1">
               <ul>
                   <li><a href="student_portal.php" class="active">Home</a></li>
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
        ...
        $sql = "SELECT * FROM student WHERE student_id=$user_id OR mobile_no=$user_id";
        $result = $conn->query($sql);
        $row = $result->fetch_assoc();
            ...
            <table align="right">
                ...
                <tr>
                    ...
                    <td colspan="2"> 
                       ...
                       <?php 
                        $sql = "SELECT * FROM instructor Natural join course where course_id IN(SELECT course_id FROM enroll WHERE student_id=$student_id)";
                        $result = $conn->query($sql);                
                        ?>
