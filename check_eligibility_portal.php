...
<html>
    ...
    <body>
        ...
        <a href="student_portal.php"><input id="b1" type="button" class="home" value="Home" style="margin-left:60px; margin-top:2px;"></a><a href="check_eligibility.php"><input id="b1" type="button" class="home" value="Back" style="margin-left:60px; margin-top:2px;"  ></a>
    </div>
...
$sql = "SELECT * FROM company WHERE criteria_10<=$tenth and criteria_12<=$twelfth and  graduation<=$graduation";
