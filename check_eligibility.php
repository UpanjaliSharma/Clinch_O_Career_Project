...
<html>
    ...
    <body>
        ...
        <a href="student_portal.php"><input id="b1" type="button" class="home" value="Home" style="margin-left:60px; margin-top:2px;"></a>
    </div>
        <div id="form">
            <form  method="post" action="check_eligibility_portal.php">
                <table cellspacing="20px" align="center" id="t1">
                    ...
                    <td>
                            <input id="user_id" type="number" name="tenth" required maxlength="15" placeholder="10th %">
                    </td>
                    </tr>
                    <tr>
                    <td>
                            <input id="user_id" type="number" name="twelfth" required maxlength="15" placeholder="12th %">
                    </td>    
                    </tr>
                    <tr>
                    <td>
                            <input id="user_id" type="number" name="graduation" required maxlength="15" placeholder="Graduation %">
                    </td>    
                    </tr>
                    <tr>
                        <td>
